...
//Statement güvenli değildir.
public class StatementTutorials {

	private static final String USERNAME="root";
	private static final String USERPASSWORD="root";
	private static final String URL="jdbc:mysql://localhost:3306/databasesIsmi?serverTimezone=Turkey";
	
	private static Connection conn=null;
	private static Statement statement; //Unutma Statement güvenlik açığını oluşturuyor. PreparedStatement ile yaz kodlarını
